...
shell("NanopolishComp Freq_meth_calculate --verbose {opt_nanopolishcomp} -i {snakemake.output.call} -b {snakemake.output.bed} -t {snakemake.output.tsv} 2>> {snakemake.log}")
